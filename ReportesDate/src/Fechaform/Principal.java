...
import Funciones.generarReporte;
...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Fecha para generación del reporte");
   ...
   public String generarFormat(){
     String fecha ="";
     String formato = this.jdFecha.getDateFormatString();
     Date date = this.jdFecha.getDate();
     SimpleDateFormat sdf = new SimpleDateFormat(formato);
     fecha = String.valueOf(sdf.format(date));
     return fecha;  
   } 
    
    public void reporte(String Jdate) {
     generarReporte reporte = new generarReporte();
     reporte.generar(Jdate);
    }
    /**
